...
<body>
    ...
    <table action="<?php echo e(route('Funcionarios.cadastro')); ?>">
        <tr>
            <th>ID</th>
            <th>Nome</th>
            <th>CPF</th>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo e(route('Funcionarios.editar', $funcionario->id)); ?>">
...
</html><?php /**PATH C:\Users\USER\Documents\GitHub\ProjetoBancoWeb\projetobanco\resources\views/Funcionarios/cadastro.blade.php ENDPATH**/ ?>